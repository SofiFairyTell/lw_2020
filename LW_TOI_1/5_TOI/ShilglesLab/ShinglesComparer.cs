...
namespace ShilglesLab.Comparers
{
    class ShinglesComparer
    {
        ...
        private int HashCount { get; set; }
        private int ShingleSize { get; set; }
        ...
        {
            List<int> HashesA = CalcMinHashesFromText(textA, HashCount, ShingleSize);
            List<int> HashesB = CalcMinHashesFromText(textB, HashCount, ShingleSize);
            return EstimateSimilarity(HashCount, HashesA, HashesB);
        }

        public int CompareHashes(List<int> hashes1, List<int> hashes2)
        {
            int sim = 0;
        ...
        private double EstimateSimilarity(int hashCount, List<int> HashesA, List<int>  HashesB) 
        {
